...
public class RecommendationBookServiceImplementation implements RecommendationBookService {

	@Autowired
	private RecommendationBookRepository recommendationbookrepository;

	@Override
	public boolean saveRecommendationBook(RecommendationBook recommendationbook)
			throws RecommendationBookAlreadyExistsException {
