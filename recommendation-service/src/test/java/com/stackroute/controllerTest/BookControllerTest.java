...
import com.stackroute.controller.RecommendationBookController;
import com.stackroute.model.RecommendationBook;
import com.stackroute.service.RecommendationBookService;


@RunWith(SpringRunner.class)
@WebMvcTest(RecommendationBookController.class)
public class BookControllerTest {
	...
	@InjectMocks
	private RecommendationBookController bookController;
	...
	public void setUp()throws Exception{
		...
		books.add(book);
        book=new RecommendationBook(600,"GOT-2","RR Martin","98745216","JohnSnow");
        books.add(book);
	...
	public void testSaveBook()throws Exception{
		...
		when(bookservice.saveRecommendationBook(book)).thenReturn(true);
		...
		verify(bookservice,times(1)).saveRecommendationBook(Mockito.any(RecommendationBook.class));
	}
	
	@Test
	public void testDeleteBookById() throws Exception {
		when(bookservice.deleteRecommendationBookById(1)).thenReturn(true);
		bookMockMvc.perform(delete("/api/bookservice/book/{id}", 1)).andExpect(status().isOk());
		verify(bookservice, times(1)).deleteRecommendationBookById(1);
	...
	public void testGetBookById() throws Exception {
		String token="eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhYSIsImlhdCI6MTU1MzA2OTcwNX0.PK-py6MXywTauPyHu-iG7BBN46E7O65JRA5bsVbsTzI";
		when(bookservice.getRecommendationBookById(1)).thenReturn(book);
		...
		verify(bookservice, times(1)).getRecommendationBookById(1);
		verifyNoMoreInteractions(bookservice);
	}

	@Test
	public void testGetAllBooks() throws Exception {
		List <RecommendationBook> books=new ArrayList<>();
		RecommendationBook book1=new RecommendationBook(700, "HP-1","JK Rowling","65478932","Harry");
		books.add(book1);
		RecommendationBook book2=new RecommendationBook(800,"HP-2","JK Rowling","85214796","Harry");
		books.add(book2);
		String token="eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhYSIsImlhdCI6MTU1MzA2OTcwNX0.PK-py6MXywTauPyHu-iG7BBN46E7O65JRA5bsVbsTzI";
		when(bookservice.getMyRecommendationBooks("aa")).thenReturn(books);
		...
		verify(bookservice, times(1)).getMyRecommendationBooks("aa");
		verifyNoMoreInteractions(bookservice);
	}
